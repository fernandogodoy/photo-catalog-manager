 ...
 */
public class ImportarDiretoricoForm extends javax.swing.JDialog {

    private static final long serialVersionUID = 1L;

    private static final String NAME = "Importador de Pastas";

    public ImportarDiretoricoForm() {
        initComponents();
        this.setModal(true);
        this.setName(NAME);
	...
	private void importar() {
		try {
			...
			controller.saveAll(Paths.get(tfLocal.getText()), Paths.get(tfNuvem.getText()));
